...
def add_latency_logs(logs):
    ...
    for tasklet_id in tasklet_ids:
        ...
        tasklet_results_received_at = get_first_occurrence_target(tasklet_executed_logs, tasklet_id)
...
def get_first_occurrence_target(df, tasklet_id):
    idx = df[df['target_id'] == tasklet_id].first_valid_index()
    if idx is not None:
        data_point = df.loc[[idx]]
        return data_point['sim_time'].values[0]
    else:
...
LOGS_FILEPATH = '/Users/d060462/Documents/GitHub/Python/20s_runs'
FINAL_LOGS_FILEPATH = '/Users/d060462/Documents/GitHub/Python/20s_runs_Result'
